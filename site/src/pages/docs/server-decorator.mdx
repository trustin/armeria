...
XXX(ikhoon): Check the follow perm link once service grpc documentation is made.
See [server-grpc-decorator](/docs/server-grpc#decoratoring-a-grpcservice) for more information.
