...
XXX(ikhoon): Check the follow link later.
Please refer to [Configure -parameters javac option](/docs/setup#configure--parameters-javac-option) for more information.
...
negotiated <type://@Produces> from `ServiceRequestContext.negotiatedResponseMediaType()` method and
